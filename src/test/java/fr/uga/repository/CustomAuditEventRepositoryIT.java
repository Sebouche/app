...
import fr.uga.config.audit.AuditEventConverter;
import fr.uga.domain.PersistentAuditEvent;
...
import static fr.uga.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
